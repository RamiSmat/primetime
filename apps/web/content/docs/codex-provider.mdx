...
description: What "primetime prime codex" does and what it requires.
---
...
Next: [GitHub Actions setup](/docs/github-actions-setup) covers how to run
this on a schedule instead of by hand.
